...
function reliableMultiply(a, b) {
  while (true) {
    try {
      ...
      // Retry only if the exception is MultiplicatorUnitFailure
      if (e instanceof MultiplicatorUnitFailure) {
        console.log("Retrying due to error:", e.message); // Debugging info
      } else {
        throw e; // Rethrow any other unexpected error
      }
    }
  }
}
